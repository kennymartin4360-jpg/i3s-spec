# Integrated Mesh Scene Layer (1.10)
...
Spec version 1.10 is backwards compatible with 1.6+.  For all of our clients to be able to read 1.7+, sharedResources and the 3DNodeIndexDocument resource are included but not used in 1.7+.

...
Version 1.10 is backwards compatible with 1.6+.  For older clients to be able to read 1.7+, sharedResources and  the 3DNodeIndexDocument resources are included.
